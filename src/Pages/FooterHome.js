            ...
            <Container fluid>
                ...
                <Grid.Row columns={3} style={{marginBottom:"50px", height:"117px"}}>
                    <Grid.Column>
                        ...
                        <p style={{color:"white"}}> <a href="#" style={{color:"white"}}>dumb-tick - is a web based platform that provides ticket to various event around sports, music, science and programming</a></p>
                        </article>
                        </div>
                    </Grid.Column>
